...
class GetFiles():
    ...
    def __init__(self):
        """
        initialise method setting range, end of range, where to save files
        :return:
        """
    ...
    def read_urls_from_files(self):
        """
        Reads the url from files and stores some values about the files
        :return:
        """
    ...
    def get_pdf(self, url):
        """
        Tries to download and convert pdf to txt, uses a java app pdf-converter that needs to be downloaded
        :param url:
        :return:
        """
